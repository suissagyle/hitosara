	...
	<header> <!-- HEADER START -->
		<div class="bg-nav">
			...
			<div class="nav-wrapper">	 <!-- NAV WRAPPER START-->
				<div class="upper-nav">
					...
					<div class="right">
						<img src="<?php echo base_url(); ?>images/pc-logo.jpg" alt="" title="Header IMAGE">
					</div>
				</div>
				<div class="right">
					...
					<!-- NAV MOBILE START -->
					<nav class="mobile cf">
						<div class="mobile-head-left apply">
		...
		<div class="sticky-panel">
			<div class="small-4 xsmall-12 img">
				<img class="wow fadeIn" data-wow-delay="0.3s" src="<?php echo base_url(); ?>images/header-logo.png" alt="" title="Header IMAGE">
			</div>
			<div class="small-4 xsmall-12 title">
				ヒトサラ掲載・登録・申込 専用サイト <span>＞＞</span>
			</div>
			<div class="small-4 xsmall-12 link">
				<a class="wow bounceIn" data-wow-delay="0.3s" href="apply">今すぐWEB申込<img src="<?php echo base_url(); ?>images/white-arrow.png"></a>
