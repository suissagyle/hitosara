		...
		<ul class="nav menu">
			...
			<li class="parent active"><a data-toggle="collapse" href="apply"><em class="fa fa-calendar">&nbsp;</em> お申込み<span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				...
				<ul class="children collapse" id="sub-item-1">
					<li><a class="active" href="<?php echo base_url() ?>index.php/application">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			...
			<table class="table">
			  	<thead>
			    	<tr>
			      		<th scope="col">申込会社名</th>
			      		<th scope="col">会社代表者名</th>
			      		<th scope="col">店舗名</th>
			      		<th scope="col">申込店舗電話番号</th>
			  	...
			  	<?php foreach ($all_new as $key => $value): ?>
				    ...
				    <tr>
				      <th scope="row"><?php echo html_escape($value->fullname); ?></th>
				      <td><?php echo html_escape($value->repname); ?></td>
				      <td><?php echo html_escape($value->storename); ?></td>
				      <td><?php echo html_escape($value->storetelno); ?></td>
				      <td><a href="<?php echo base_url() ?>index.php/application/edit/<?php echo html_escape($value->id); ?>">編集</a>&nbsp;|&nbsp;<?php echo anchor('index.php/Application/delete/' . html_escape($value->id), '削除', 'onClick="return confirm(\'Please confirm if you want to delete？\');"'
	                    ); ?></td>
				      <!-- <td><a href="<?php echo base_url() ?>index.php/application/details/<?php echo html_escape($value->id); ?>">詳細</a></td> -->
				    </tr>
